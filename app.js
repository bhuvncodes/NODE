import { firebaseConfig, GEMINI_URL } from "./firebaseConfig.js";
if(!firebase.apps.length){
firebase.initializeApp(firebaseConfig);
console.log("Firebase initialized:");
}
else{
    console.log("Firebase already initailized");
}
...
function signupUser() {
    ...
    .then(userCredential => {
        ...
        // Write to Firestore (users collection, document = uid)
...
function loginUser() {
    ...
    .then(userCredential => {
        ...
        // Redirect to dashboard to check idea progress and requirements
        window.location = "dashboard.html";
    })
    .catch(error => {
        alert(error.message);
